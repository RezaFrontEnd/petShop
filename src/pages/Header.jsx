...
function Header() {
  ...
  return (
    <>
      <header>
        <div className="mx-75 mt-3 bg-white">
          <div className="flex w-full items-center justify-between rounded-xl border border-black p-2">
            ...
            <div className="flex items-start justify-between">
              <div className="flex space-x-1 text-[0.5rem] text-gray-500">
                <i className=" bi bi-facebook cursor-pointer transition duration-300 hover:text-black">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                ...
                <i className=" bi bi-twitter cursor-pointer transition duration-300 hover:text-black">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                ...
                <i className="bi bi-instagram cursor-pointer transition duration-300 hover:text-black">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                ...
                <i className="bi bi-youtube cursor-pointer transition duration-300 hover:text-black">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                ...
                <i className="bi bi-pinterest cursor-pointer transition duration-300 hover:text-black">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
        ...
        <div className="mx-65 -mt-2 bg-white">
          <div className="flex min-h-[30px] w-full items-center justify-between rounded-xl border border-black p-4">
            ...
            <nav>
              <ul className="flex items-center space-x-3 text-sm">
                ...
                <li className="transition duration-300 hover:text-orange-300 text-sm">
                  <a href="">فروشگاه</a>
                </li>
                <li className="transition duration-300 hover:text-orange-300 text-sm">
                  <a href="">وبلاگ</a>
